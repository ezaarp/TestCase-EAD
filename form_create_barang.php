                ...
                <div class="card">
                    <div class="card-body">
                        <form action="create.php" method="POST" enctype="multipart/form-data" name="form_create">
                            ...
                            <div class="form-floating mb-3">
                                <input type="string" class="form-control" id="jenis_barang" name="jenis_barang">
                                <label for="jenis_barang">Jenis Barang</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="string" class="form-control" id="lokasi_barang" name="lokasi_barang">
                                <label for="lokasi_barang">Lokasi Terakhir/TKP</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="string" class="form-control" id="kontak" name="kontak">
